...
class Simulation:
    def __init__(
        ...
        measurement_function: Callable[[List, List], float],
    ):
        self.indices = indices
        self.measurement_function = measurement_function

    def run(
        self, matches: List[Match], correct_ranks: List[Tuple[int, str]]
    ) -> Dict[str, float]:
        results = {}
...
if __name__ == "__main__":
    ...
    from ripper.utils import calculate_accuracy, list_team_names
